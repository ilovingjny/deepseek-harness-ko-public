...
export const ko = {
  ...
  'run.removed': '패키지가 더 이상 존재하지 않습니다',
  'run.superseded': '아래에서 새 실행 카드를 확인하세요',
  'panel.hint': '실행 제어는 설정 위 왼쪽 아래의 Cordis 패널에 있습니다',
  'panel.plugins.aria': 'Cordis 플러그인',
  'panel.approvals.aria': 'Cordis 승인',
  'panel.trigger': 'Cordis 플러그인',
  'panel.runningCount': '{count}개 실행 중',
  ...
  'action.retry': '다시 시도',
  'action.rollback': '롤백',
  'render.failedAbdicated': '{slot} 렌더링에 실패해 기본 UI로 복원했습니다:',
  'render.failedHeld': '{slot} 렌더링에 실패했습니다:',
